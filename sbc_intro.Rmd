...
knitr::opts_chunk$set(echo=FALSE, fig.width = 4, fig.height=2.5)
```
...
plot_rank_hist(rank_dfs[[2]], max_rank = max_rank) + ggtitle("Overdispersed")
plot_rank_hist(rank_dfs[[3]], max_rank = max_rank) + ggtitle("Underdispersed")
```
...
```{r}
plot_rank_hist(rank_dfs[[4]], max_rank = max_rank) + ggtitle("Overestimating")
plot_rank_hist(rank_dfs[[5]], max_rank = max_rank) + ggtitle("Underestimating")
...
plot_ecdf(rank_dfs[[2]], max_rank = max_rank) + ggtitle("Overdispersed")
plot_ecdf(rank_dfs[[3]], max_rank = max_rank) + ggtitle("Underdispersed")
```
...
```{r}
plot_ecdf(rank_dfs[[4]], max_rank = max_rank) + ggtitle("Overestimating")
plot_ecdf(rank_dfs[[5]], max_rank = max_rank) + ggtitle("Underestimating")
...
plot_ecdf_diff(rank_dfs[[2]], max_rank = max_rank) + ggtitle("Overdispersed")
plot_ecdf_diff(rank_dfs[[3]], max_rank = max_rank) + ggtitle("Underdispersed")
```
...
```{r}
plot_ecdf_diff(rank_dfs[[4]], max_rank = max_rank) + ggtitle("Overestimating")
plot_ecdf_diff(rank_dfs[[5]], max_rank = max_rank) + ggtitle("Underestimating")
